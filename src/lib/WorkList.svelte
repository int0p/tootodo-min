...
<ListBox class="flex flex-wrap justify-start items-center space-x-1 w-full h-full overflow-y-scroll hide-scrollbar">
    <ListBoxItem bind:group={valueSingle} name="medium" value="X" class="!py-0 relative left-1">X</ListBoxItem>
