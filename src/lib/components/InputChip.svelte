...
<div class="input-chip {classesBase}" class:opacity-50={$$restProps.disabled}>
    ...
    <div class="input-chip-interface {classesInterface}">
        ...
        {#if chipValues.length}
            <!-- todo: 내가 추가한 기능- 칩 추가시 최대 높이 조절 기능 추가-->
            <div class="input-chip-list {classesChipList} max-h-[100px] overflow-y-auto hide-scrollbar" transition:fly|local={{ duration, opacity: 0, y: -20 }}>
